...
def generate_prompt(base_folder, column_types, summary_stats, missing_values, outliers, skewness_values, pca_variance, clusters, correlation_matrix=None):
    """Generate an optimized prompt for LLM."""
    prompt = f"""
...
Write a story summarizing the dataset, key findings, and actionable insights. Include references to visualizations and their implications.
"""
    return prompt
